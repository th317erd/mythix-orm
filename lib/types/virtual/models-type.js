...
const INJECT_TYPE_METHODS = {
  ...
  'get': async function*({ field, type }, _queryEngine, _options) {
  ...
  'removeFrom': async function({ field, type }, _models, _options) {
    ...
    return this.getConnection().transaction(async (connection) => {
      ...
      if (needsLoad()) {
        ...
        storedModels      = await Utils.collect(this[getMethodName](query, Object.assign({}, options, { includeRelations: true })));
      } else {
        storedModels = models;
      }
