...
class ModelScope extends QueryEngineBase {
  ...
  /// a `+`, and if a `+` operation doesn't come before the encountered field, then
  ...
  /// apply with a wildcard. So in our example above we are "replacing" the projection, since no `+` was
