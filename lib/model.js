...
class Model {
  ...
  /// <see>setDataValue</see> instance methods will bypass
  ...
  /// for fields as defined by <see>Model._constructFields</see>.
  ...
  /// Objects, which is never guaranteed.
  ///
  /// Note:
  ...
  /// dirty state, and then `true` will be returned, letting the caller
  ...
  ///   to will need to create your own "reload" operation.
  /// Return: undefined
  /// Arguments:
  ///   options?: object
  ...
  ///   A primary key is required on the model for this method
  ///   to work. If you don't have a primary key defined, then
  ///   to will need to create your own "destroy" operation.
  /// Return: number
