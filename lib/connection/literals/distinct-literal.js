...
/// Define an "distinct" literal for the underlying database.
///
...
/// a field, another literal, or `false` as its only argument. It may
/// or may not use this field in any underlying operations, but to remain
/// consistent in the interface and across databases, it is required. If
/// `false` is provided, it will turn any previous `DISTINCT` in the operation
/// off. There are some cases in which a `DistinctLiteral` may not alter how
